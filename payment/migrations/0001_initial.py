    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "delivery_name",
                    models.CharField(max_length=255, verbose_name="delivery_name"),
                ),
                (
                    "delivery_price",
                    models.DecimalField(
                        decimal_places=2, max_digits=9, verbose_name="delivery price"
                    ),
                ),
                (
                    "delivery_method",
                ...
                (
                    "delivery_timeframe",
                    models.CharField(max_length=255, verbose_name="delivery timeframe"),
                ),
